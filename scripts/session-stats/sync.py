#!/usr/bin/env python3
"""
Sync ~/.omp-cyberstrike/agent/sessions/**/*.jsonl into ~/.omp-cyberstrike/stats.db (ss_* tables).
...
SESSIONS_ROOT = Path.home() / ".omp-cyberstrike" / "agent" / "sessions"
DB_PATH = Path.home() / ".omp-cyberstrike" / "stats.db"
