...
Search roots come from `.omp-cyberstrike` directories:

- project: `<cwd>/.omp-cyberstrike/commands/*.md`
- user: active profile agent directory `commands/*.md` (`~/.omp-cyberstrike/agent/commands/*.md` for the default profile; `~/.omp-cyberstrike/profiles/<name>/agent/commands/*.md` for a named profile)
