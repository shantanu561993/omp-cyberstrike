...
- default: `~/.omp-cyberstrike/agent/themes`
...
- default agent dir: `~/.omp-cyberstrike/agent`
- effective default file: `~/.omp-cyberstrike/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.omp-cyberstrike/agent/themes/my-theme.json`.
