...
rm -rf /srv/agent-home/.agent /srv/agent-home/.omp-cyberstrike/agent
mkdir -p /srv/agent-home/.agent /srv/agent-home/.omp-cyberstrike/agent
if [ -e /srv/agent-home-stage/.agent ]; then
    cp -a /srv/agent-home-stage/.agent/. /srv/agent-home/.agent/
fi
if [ -e /srv/agent-home-stage/.omp-cyberstrike/agent ]; then
    cp -a /srv/agent-home-stage/.omp-cyberstrike/agent/. /srv/agent-home/.omp-cyberstrike/agent/
fi
...
# omp registers daemon project presence under ~/.omp-cyberstrike/run at startup, nesting
...
mkdir -p /srv/agent-home/.omp-cyberstrike/run
chgrp -R omp /srv/agent-home/.omp-cyberstrike/run
chmod -R g+rwX /srv/agent-home/.omp-cyberstrike/run
find /srv/agent-home/.omp-cyberstrike/run -type d -exec chmod g+s {} +
chmod 2770 /srv/agent-home/.omp-cyberstrike/run
