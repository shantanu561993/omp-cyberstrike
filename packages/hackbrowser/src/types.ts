...
export interface AgentConfig {
	...
	auth: {
		...
		// before teardown so callers can export the authenticated session
		// (saveSession / cookie jar / auth headers).
		onCrawlEnd?: (context: import("playwright").BrowserContext) => Promise<void>;
	};
