 ...
 * - ~/.omp-cyberstrike/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.omp-cyberstrike/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.omp-cyberstrike/agent/extensions/ or .omp-cyberstrike/extensions/
