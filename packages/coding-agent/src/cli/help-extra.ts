...
${chalk.bold("Useful Commands:")}
  omp agents unpack           - Export bundled subagents to ~/.omp-cyberstrike/agent/agents (default)
  omp agents unpack --project - Export bundled subagents to ./.omp-cyberstrike/agents`;
}
