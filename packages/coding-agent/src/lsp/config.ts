...
function getConfigSources(cwd: string): ConfigSource[] {
	...
	// Project config directories (.omp-cyberstrike/, .pi/, .claude/)
	...
	// User config directories (~/.omp-cyberstrike/agent/, ~/.pi/agent/, ~/.claude/)
 ...
 * 2. Project config dirs: .omp-cyberstrike/lsp.*, .pi/lsp.*, .claude/lsp.* (+ hidden variants)
 * 3. User config dirs: ~/.omp-cyberstrike/agent/lsp.*, ~/.pi/agent/lsp.*, ~/.claude/lsp.* (+ hidden variants)
