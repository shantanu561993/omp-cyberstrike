...
export const SETTINGS_SCHEMA = {
		...
		ui: {
			...
			options: [
				...
				},
				{
					...
					label: "Per-project",
					description:
						"Save project role models in .omp-cyberstrike/config.yml; missing project roles use global defaults",
				},
			],
		},
	},
	...
	// and mint/enhance isolated managed skills under ~/.omp-cyberstrike/agent/managed-skills.
	...
	"hindsight.retainContext": { type: "string", default: "omp-cyberstrike" },
	...
	"github.cache.enabled": {
		...
		ui: {
			...
			description:
				"Cache rendered issue/PR view output in ~/.omp-cyberstrike/cache/github-cache.db so repeated reads are free",
		},
	},
	...
	"worktree.base": {
		...
		ui: {
			...
			description:
				"Base directory for agent-managed worktrees — task-isolation copies, `github` PR checkouts, and `omp worktree` cleanup all live here. Unset uses ~/.omp-cyberstrike/wt. Must be an absolute or ~-relative path; relative paths are ignored. The OMP_WORKTREE_DIR env var overrides this.",
		},
	},
