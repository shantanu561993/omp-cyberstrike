 ...
 * isolated directory (`~/.omp-cyberstrike/agent/managed-skills`) separate from
 * user-authored skills (`~/.omp-cyberstrike/agent/skills`). They are discovered and
...
/** Resolve the isolated managed-skills directory (`~/.omp-cyberstrike/agent/managed-skills`). */
