...
Managed skills: `SKILL.md` in isolated `~/.omp-cyberstrike/agent/managed-skills`; surfaced in future sessions like other skills.
...
Isolation: managed skills ONLY writable skills. NEVER edit user-authored skills in `~/.omp-cyberstrike/agent/skills` or `.omp-cyberstrike/skills`.
