 ...
 *
 * Utilities for reading/writing .omp-cyberstrike/mcp.json files at user or project level.
 */
...
export interface SetMcpServerEnabledOptions {
	 ...
	 * formats this codebase owns (native `.omp-cyberstrike/mcp.json` and `mcp-json`
