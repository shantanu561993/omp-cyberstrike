...
- **Session log parsing**: Reads JSONL session logs from `~/.omp-cyberstrike/agent/sessions/`
...
- **Session logs**: `~/.omp-cyberstrike/agent/sessions/` (JSONL files)
- **Stats database**: `~/.omp-cyberstrike/stats.db` (SQLite)
